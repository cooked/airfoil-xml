...
/**
 * This is the item provider adapter for a {@link com.stefanocottafavi.airfoil.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AirfoilPackage.Literals.DOCUMENT_ROOT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addXPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_x_feature", "_UI_DocumentRoot_type"),
				 AirfoilPackage.Literals.DOCUMENT_ROOT__X,
				 true,
				 false,
				 false,
	...
	protected void addYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_y_feature", "_UI_DocumentRoot_type"),
				 AirfoilPackage.Literals.DOCUMENT_ROOT__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addZPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_z_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_z_feature", "_UI_DocumentRoot_type"),
				 AirfoilPackage.Literals.DOCUMENT_ROOT__Z,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AirfoilPackage.Literals.DOCUMENT_ROOT__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addName1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_name1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_name1_feature", "_UI_DocumentRoot_type"),
				 AirfoilPackage.Literals.DOCUMENT_ROOT__NAME1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AirfoilPackage.Literals.DOCUMENT_ROOT__AIRFOIL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AirfoilPackage.Literals.DOCUMENT_ROOT__AIRFOIL,
				 AirfoilFactory.eINSTANCE.createAirfoilType()));
	}
