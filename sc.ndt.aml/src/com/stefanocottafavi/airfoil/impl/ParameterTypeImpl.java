 ...
 * <ul>
 *   <li>{@link com.stefanocottafavi.airfoil.impl.ParameterTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterTypeImpl extends MinimalEObjectImpl.Container implements ParameterType {
	...
	protected EClass eStaticClass() {
		return AirfoilPackage.Literals.PARAMETER_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AirfoilPackage.PARAMETER_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AirfoilPackage.PARAMETER_TYPE__NAME:
				return getName();
		}
